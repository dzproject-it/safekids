...
export const imgContainer = (bg: string) => `${bg} h-40 sm:h-52 md:h-64 flex items-center justify-center relative`;
export const img          = 'w-full h-full object-contain p-3 sm:p-4 transition-transform duration-500 group-hover:scale-105';
...
export const info         = 'p-3 sm:p-4 flex flex-col flex-1';
...
export const price        = 'text-base sm:text-xl font-bold text-dark';
export const oldPrice     = 'text-sm text-gray-400 line-through';
export const addBtn       = 'w-full bg-dark text-white py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-semibold hover:bg-primary transition-all duration-200 flex items-center justify-center gap-1.5 sm:gap-2 whitespace-nowrap cursor-pointer';
