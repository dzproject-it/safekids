...
export const imgContainer = (bg: string) => `${bg} rounded-3xl p-8 mb-6 overflow-hidden relative h-96 flex items-center justify-center transition-transform duration-300 group-hover:scale-105`;
