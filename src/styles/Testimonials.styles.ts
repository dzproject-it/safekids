...
export const authorHandle = 'text-gray-400 text-sm';
export const text       = 'text-gray-medium text-sm leading-relaxed';
export const starsRow   = 'flex items-center space-x-1 mt-6';
export const star       = 'ri-star-fill text-tertiary text-lg';
